...
class BinaryTree:
    ...
    def inorden_criaturas(self):
        def __inorden_criaturas(root):
            if root is not None:
                ...
                print(f'{root.value}, derrotado por: ', root.other_values['derrotado'])
    ...
    def inorden_derrotatos_heracles(self):
        def __inorden_d_h(root):
            if root is not None:
                __inorden_d_h(root.right)
                if root.other_values['derrotado'] == 'Heracles':
                    print(root.value)
                __inorden_d_h(root.left)

        __inorden_d_h(self.root)
    
    def inorden_capturados_heracles(self):
        def __inorden_c_h(root):
            if root is not None:
                __inorden_c_h(root.right)
                if root.other_values['capturado'] == 'Heracles':
                    print(root.value)
                __inorden_c_h(root.left)

        __inorden_c_h(self.root)

    def inorden_no_derrotatos(self):
        def __inorden_n_d(root):
            if root is not None:
                __inorden_n_d(root.right)
                if root.other_values['derrotado'] is None:
                    print(root.value)
                __inorden_n_d(root.left)

        __inorden_n_d(self.root)
    ...
    def inorden_add_descripcio(self):
        def __inorden_add_descripcio(root):
            if root is not None:
                __inorden_add_descripcio(root.left)
                root.other_values['descripcio'] = None
                __inorden_add_descripcio(root.right)

        __inorden_add_descripcio(self.root)
    ...
    def inorden_super_or_villano(self):
        def __inorden_s_v(root):
            if root is not None:
                __inorden_s_v(root.left)
                if root.other_values is False:
                    print(root.value)
                __inorden_s_v(root.right)

        __inorden_s_v(self.root)
    ...
    def postorden_super_or_villano(self):
        def __postorden_s_v(root):
            if root is not None:
                __postorden_s_v(root.right)
                if root.other_values is True:
                    print(root.value)
                __postorden_s_v(root.left)

        __postorden_s_v(self.root)
